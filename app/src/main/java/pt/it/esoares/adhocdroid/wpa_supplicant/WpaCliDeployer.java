...
import pt.it.esoares.adhocdroid.util.tasks.FileCopyFromResources;

public class WpaCliDeployer
		extends
		AsyncTask<pt.it.esoares.adhocdroid.wpa_supplicant.WpaCliDeployer.Data, Integer, pt.it.esoares.adhocdroid.wpa_supplicant.WpaCliDeployer.Result> {
